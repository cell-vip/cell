...
public:
    ...
    bool CreateTransactionB(const std::vector<std::pair<CScript, int64> >& vecSend,const CTxDestination& address1, CWalletTx& wtxNew, CReserveKey& reservekey, int64& nFeeRet);
    bool CreateTransactionB(CScript scriptPubKey,const CTxDestination& address1, int64 nValue, CWalletTx& wtxNew, CReserveKey& reservekey, int64& nFeeRet);
    ...
    std::string SendMoney(CScript scriptPubKey, int64 nValue, CWalletTx& wtxNew, bool fAskFee=false);
  	std::string SendMoneyB(CScript scriptPubKey,const CTxDestination& address1,  int64 nValue, CWalletTx& wtxNew, bool fAskFee=false);
    std::string SendMoneyToDestination(const CTxDestination &address, int64 nValue, CWalletTx& wtxNew, bool fAskFee=false);
		std::string SendMoneyToDestinationB(const CTxDestination &address,const CTxDestination& address1, int64 nValue, CWalletTx& wtxNew, bool fAskFee=false);
