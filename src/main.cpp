...
int64 nChainStartTime = 1598431511;
...
int64 GetProofOfWorkReward(int nHeight, int64 nFees, uint256 prevHash)
{
	...
	if(nHeight == 1)
	{
		nSubsidy = 6400000000 * COIN;	// 1 billion coins, that all pow coins
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // Genesis block
        const char* pszTimestamp = "Aug 26 2020, Start for RCE coin";
        CTransaction txNew;
        ...
        printf("block.nNonce = %u \n", block.nNonce);
			block.print();
        assert(block.hashMerkleRoot == uint256("0x19dd477e755da8efe59146e1f8a574d5ea66c17ca5d143c7ca5fc9c970945dc8"));
...
unsigned char pchMessageStart[4] = { 0xde, 0xfe, 0xda, 0xdd };
...
CBlock* CreateNewBlock(CWallet* pwallet, bool fProofOfStake)
{
    ...
    if (0)  // attempt to find a coinstake  fProofOfStake
    {
